...
# Custom compiler tests are temporarily disabled due to register allocation conflicts
# These need to be fixed after the register-based VM is fully stabilized
